            ...
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        ...
                        <hr />
                        <div className='flex w-full items-center flex-col mt-5 gap-3 bg-gray-400 rounded-3xl'>
                            <button onClick={handleRegister} className='block text-white font-bold'><img src={googlelogo} className='w-12 h-12 inline-block' alt="Google logo"/>Login with Google</button>
                        </div>
